			...
			<div class="container container-footer-info"">
				...
				<div class="footer-copyright">
					...
					printf(
						...
						sprintf( '<a href="http://oppr.io/" rel="nofollow">%s</a>', esc_html__( 'oppr', 'zillah' ) )
					);
					?>
					<span class="sep"> | </span>
					<?php
					printf(
						...
						__( 'Developed by %1$s', 'zillah' ),
						/* translators: s: 'Themeisle' */
						sprintf( '<a href="http://dev.oppr.io/" rel="nofollow">%s</a>', esc_html__( 'opprDev Team', 'zillah' ) )
					);
					?>
				</div>
